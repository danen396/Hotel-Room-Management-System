<%-- 
    Document   : ManagerLink
    Created on : Aug 2, 2017, 10:18:55 AM
    Author     : danen
--%>
    ...
    <body>
     <header class="w3-display-container w3-content w3-center" style="max-width:1500px">
        ...
        <div class="w3-display-middle w3-padding-large w3-border w3-wide w3-text-light-grey w3-center">
            ...
            <h3 class="w3-hide-medium w3-hide-small">Manager</h3>
        </div>
        ...
        <div class="w3-bar w3-light-grey w3-round w3-display-bottommiddle w3-hide-small" style="bottom:-16px">
            ...
            <a href="ManagerCreateNewUser.jsp" class="w3-bar-item w3-button">Add new user |</font></a>
            <a href="SearchStaff.jsp" class="w3-bar-item w3-button">Edit user |</font></a>
