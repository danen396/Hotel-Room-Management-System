...
public class EditStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        staffToEdit.setPassword(password);
        staffToEdit.setDepartment(department);
        staffToEdit.setIcOrPassport(icOrPassport);
        staffToEdit.setPhoneNumber(phoneNumber);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<h1>" + staffToEdit.getUsername() + "'s account is updated </h1>");
