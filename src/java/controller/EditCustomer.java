...
public class EditCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Customer customerToEdit = (Customer) session.getAttribute("staffToEdit");
        ...
        customerToEdit.setIcOrPassport(icOrPassport);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<h1>" + customerToEdit.getUsername() + "'s account is updated </h1>");
